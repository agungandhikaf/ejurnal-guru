...
function registerIpc(): void {
  ...
  handle(IPC.SCHEDULES_LIST, (payload) => service.listSchedules(payload as never))
  handle(IPC.SCHEDULES_BY_DATE, (payload) => service.listSchedulesByDate(payload as never))
  handle(IPC.SCHEDULES_CREATE, (payload) => service.createSchedule(payload as never))
  handle(IPC.SCHEDULES_UPDATE, (payload) => service.updateSchedule(payload as never))
  handle(IPC.SCHEDULES_DELETE, (payload) => service.deleteSchedule(payload as never))
  handle(IPC.SCHEDULES_BULK_DELETE, (payload) => service.bulkDeleteSchedules(payload as never))
  ...
  handle(IPC.JOURNALS_DELETE, (payload) => service.deleteJournal(payload as never))
