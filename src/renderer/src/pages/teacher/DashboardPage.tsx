...
export default function DashboardPage({ session }: { session: LoginSession }): JSX.Element {
  ...
  return (
    <div className="space-y-6">
      <div className="relative shrink-0 overflow-hidden rounded-3xl bg-[#C43670] p-7 text-white shadow-[0_16px_36px_rgba(196,54,112,0.18)]">
      ...
      <div className="card rounded-2xl border border-[#C43670]/10 bg-white p-6 shadow-[0_10px_28px_rgba(196,54,112,0.07)]">
